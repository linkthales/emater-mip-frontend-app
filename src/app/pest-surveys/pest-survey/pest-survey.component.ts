...
@Component({
  selector: 'app-pest-survey',
  templateUrl: './pest-survey.component.html',
  styleUrls: ['./pest-survey.component.scss']
})
export class PestSurveyComponent implements OnInit {
  ...
  public tableKeys = ['harvest.description', 'field.name', 'field.location', 'city.name', 'plant', 'farmer.name', 'supervisor.name', 'actions'];
  public tableWidth = [150, 150, 100, 100, 150, 100, 100, 100];
